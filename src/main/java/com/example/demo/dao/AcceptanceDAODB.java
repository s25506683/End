...
//jdbcTemplate 
	...
	public int insert(Acceptance acceptance) {
		return jdbcTemplate.update(
				...
				acceptance.getAccept_std_id(), acceptance.getAccept_hw_id(), acceptance.getAccept_score(),
				acceptance.isAccept_done());
	}

	public Acceptance findOne(int id) {
		return this.jdbcTemplate.queryForObject(
				"select accept_id, accept_std_id, accept_hw_id, accept_time, accept_score, accept_done from acceptance where accept_id = ?",
				new Object[] { id }, new AcceptanceMapper());
	}

	public List<Acceptance> findAll(String cs_id, String hw_name) {
		return this.jdbcTemplate.query(
				"select a.accept_id, a.accept_std_id, a.accept_hw_id, a.accept_time, a.accept_score, a.accept_done, hw.hw_name from acceptance a inner join homework hw on hw.hw_id = a.accept_hw_id where hw.hw_cs_id = ? and hw.hw_name = ?",
	...
	public int update(Acceptance acceptance) {
		return jdbcTemplate.update(
				...
				acceptance.getAccept_std_id(), acceptance.getAccept_hw_id(), acceptance.getAccept_score(),
				acceptance.isAccept_done(), acceptance.getAccept_std_id());
	}

	public int delete(int std_id) {
		return jdbcTemplate.update("delete from acceptance where accept_std_id =?", std_id);
	}
