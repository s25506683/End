...
//   .formLogin().loginPage("/login").defaultSuccessUrl("http://qrgosystem.nctu.me:3000/loading").failureUrl("http://qrgosystem.nctu.me:3000").permitAll()
//   .and()
//   .logout().logoutRequestMatcher(new AntPathRequestMatcher("/logout")).logoutSuccessUrl("http://qrgosystem.nctu.me:3000");
  // .and()
  // .formLogin().disable();
